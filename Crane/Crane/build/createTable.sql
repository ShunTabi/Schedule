...
REVIEWENDDATE DATETIME NOT NULL DEFAULT CURRENT_DATE,
REVIEWVISIBLESTATUS INTEGER NOT NULL DEFAULT 0,
REVIEWUPDATEDATE DATETIME NOT NULL DEFAULT CURRENT_DATE,
UNIQUE(PLANID,REVIEWNAME),
FOREIGN KEY(REVIEWID) REFERENCES T_PLAN(PLANID) ON DELETE CASCADE
);
