...
CREATE TABLE T_TODAYWORK (
TODAYWORKID INTEGER PRIMARY KEY AUTOINCREMENT,
WORKID INTEGER NOT NULL,
STATUSID INTEGER NOT NULL,
TODAYWORKDATE DATETIME NOT NULL DEFAULT CURRENT_DATE,
TODAYWORKSTARTTIME DATETIME NOT NULL DEFAULT CURRENT_DATE,
TODAYWORKENDTIME DATETIME NOT NULL DEFAULT CURRENT_DATE,
TODAYWORKUPDATEDATE DATETIME NOT NULL DEFAULT CURRENT_DATE,
FOREIGN KEY(TODAYWORKID) REFERENCES T_WORK(WORKID) ON DELETE CASCADE
);